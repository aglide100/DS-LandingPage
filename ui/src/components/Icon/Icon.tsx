...
const Logo = (
  ...
  >
    ...
    <defs>
      ...
      >
        <stop offset="0" stopColor="#4d4d4d" />
        <stop offset=".03" stopColor="#595959" />
        <stop offset=".14" stopColor="#858585" />
        <stop offset=".27" stopColor="#aaa" />
        <stop offset=".39" stopColor="#c9c9c9" />
        <stop offset=".52" stopColor="#e1e1e1" />
        <stop offset=".66" stopColor="#f2f2f2" />
        <stop offset=".81" stopColor="#fcfcfc" />
      ...
      >
        ...
        <stop offset=".03" stopColor="#393939" />
        <stop offset=".29" stopColor="#7f7f7f" />
        <stop offset=".53" stopColor="#b6b6b6" />
        <stop offset=".74" stopColor="#dedede" />
        <stop offset=".9" stopColor="#f6f6f6" />
        <stop offset="1" stopColor="#fff" />
      </linearGradient>
      <linearGradient
      ...
      >
        <stop offset="0" stopColor="#333" />
        <stop offset=".02" stopColor="#393939" />
        <stop offset=".29" stopColor="#7f7f7f" />
        <stop offset=".53" stopColor="#b6b6b6" />
        <stop offset=".74" stopColor="#dedede" />
        <stop offset=".9" stopColor="#f6f6f6" />
      ...
      >
        ...
        <stop offset=".06" stopColor="#f6f6f6" />
        <stop offset=".15" stopColor="#dedede" />
        <stop offset=".26" stopColor="#b6b6b6" />
        <stop offset=".39" stopColor="#7f7f7f" />
        <stop offset=".45" stopColor="#666" />
        <stop offset=".48" stopColor="#565656" />
        <stop offset=".5" stopColor="#4d4d4d" />
        <stop offset=".55" stopColor="#666" />
        <stop offset=".61" stopColor="#7f7f7f" />
        <stop offset=".74" stopColor="#b6b6b6" />
        <stop offset=".85" stopColor="#dedede" />
      ...
      >
        <g filter="url(#luminosity-noclip-8)" mask="url(#mask)">
          <path
            d="M41.22 15.34c-6-5.12-13.81-5.9-21.41-6v9c5 0 10.54.14 14.85 3.1a16.68 16.68 0 016.8 13.8 16.5 16.5 0 01-6.18 12.88c-4.45 3.31-10.11 3.53-15.47 3.53v9c7.85 0 15.24-.62 21.42-5.9A26.69 26.69 0 0050 35.28c0-7.28-3.15-15.22-8.78-19.94z"
      ...
      >
        <g filter="url(#luminosity-noclip-9)" mask="url(#mask-4)">
          <path
            ...
            d="M10.85 9.36h8.96V60.7h-8.96z"
          />
        </g>
      </mask>
      <mask
      ...
      >
        <g filter="url(#luminosity-noclip-10)" mask="url(#mask-5)">
          <path
            d="M75.24 22.83l8.66-4.11A15.12 15.12 0 0069.75 8.59v9.15c4.33.36 5.39 4.78 5.49 5.09z"
            style={{ mixBlendMode: "multiply" }}
      ...
      >
        <g filter="url(#luminosity-noclip-11)" mask="url(#mask-6)">
          <path
            d="M62.1 46.31l-8.39 4.23c2.15 6.68 9.33 11.16 16 10.92v-9.11c-4.04-.11-6.13-2.16-7.61-6.04z"
            style={{ mixBlendMode: "multiply" }}
      ...
      >
        <g filter="url(#luminosity-noclip-12)" mask="url(#mask-7)">
          <path
            d="M80.47 33.9c-1.8-1.27-3.24-2.55-10.72-5-.83-.27-5.54-1.64-5.54-5.88 0-3.21 2-5.32 5.54-5.32V8.59c-8.08 0-14.92 6.17-14.92 14.47 0 7.8 6.18 11.58 7.36 12.21 1.65.9 6.85 2.59 7.57 2.88 1.83.74 6.67 2.55 6.67 7.27a6.42 6.42 0 01-6.67 6.93v9.11a16.2 16.2 0 0016.08-16c-.02-1.82-.3-7.99-5.37-11.56z"
            style={{ mixBlendMode: "multiply" }}
      ...
      >
        <g filter="url(#luminosity-noclip-13)" mask="url(#mask-2)">
          <path
            d="M122.85 54.88c3.29-4 3.7-8.71 3.7-13.71V9.37h-9.4v31.8c0 2.67.07 5.27-1.37 7.61a7.72 7.72 0 01-6.35 3.56v9.12a18.06 18.06 0 0013.42-6.58z"
            style={{ mixBlendMode: "multiply" }}
      ...
      >
        <g filter="url(#luminosity-noclip-14)" mask="url(#mask-3)">
          <path
            d="M96 54.87c-3.3-4-3.71-8.71-3.71-13.71V9.36h9.4v31.8c0 2.67-.07 5.28 1.37 7.61a7.72 7.72 0 006.35 3.57v9.12A18.07 18.07 0 0196 54.87z"
            style={{ mixBlendMode: "multiply" }}
    ...
    <g mask="url(#mask-9)">
      <path d="M10.85 9.36h8.96V60.7h-8.96z" style={{ fill: "#df002b" }} />
    </g>
    <g mask="url(#mask-10)">
      <path
        d="M75.24 22.83l8.66-4.11A15.12 15.12 0 0069.75 8.59v9.15c4.33.36 5.39 4.78 5.49 5.09z"
